...
for neu in range(n_neurons):
    ...
    coeffs[neu] = model.coef_
    intercepts[neu] = model.intercept_
...
fhname = f"../results/RidgeFitAllNeurons_DT_{int(1000*dt_sec)}ms_NBasis_{n_basis_funcs}_WindowSize_{window_size}.npz"
np.savez(fhname,
        dt_sec = dt_sec,
